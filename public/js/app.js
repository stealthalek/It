(() => {
  ...
  const TRANSLATIONS = {
    it: {
      ...
      perm_rooms_manage: 'Gestire sale riunioni', perm_ideas_manage: 'Gestire bacheca idee', perm_wiki_manage: 'Gestire wiki interno',
    ...
    en: {
      ...
      perm_rooms_manage: 'Manage meeting rooms', perm_ideas_manage: 'Manage idea board', perm_wiki_manage: 'Manage internal wiki',
